...
namespace RankingApp.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        {
            new ItemModel{ Id = 1, Title = "TheGodfather", ImageId=1, Ranking=0, ItemType=1 },
            ...
            new ItemModel{ Id = 12, Title = "Adrenalinze", ImageId=12, Ranking=0, ItemType=2 },
            ...
            new ItemModel{ Id = 16, Title = "Ride the Lightining", ImageId=16, Ranking=0, ItemType=2 },
        ...
        {
            ItemModel[] items = Items.Where(items => items.ItemType == itemType).ToArray();
